...
const HostDashboard = () => {
    ...
    const handleAcceptRequest = (booking) => {
        alert(`Accepted booking request from: ${booking.guestName}\n\nThe guest will be notified and you can proceed with scheduling.`);
    ...
    const handleDeclineRequest = (booking) => {
        const reason = prompt(`Decline booking from: ${booking.guestName}\n\nOptional: Provide a reason:`);
        alert(`Booking request declined. The guest will be notified.`);
        // In a real app, this would update the booking status in the backend
            ...
            <div className="container">
                <div className="dashboard-header">
                    <div>
                        ...
                        <p className="dashboard-subtitle">Manage your podcast and upcoming episodes</p>
                    </div>
                ...
                <div className="dashboard-grid">
                    <div className="dashboard-section">
                        <div className="section-header-inline">
                            <h2 className="section-title-small">Upcoming Episodes</h2>
                        ...
                        <div className="bookings-list">
                            {upcomingBookings.length > 0 ? (
                                upcomingBookings.map(booking => (
                                    <div key={booking.id} className="booking-card">
                                        <div className="booking-header">
                                            <div>
                                                <h3 className="booking-title">{booking.topic}</h3>
                                                <p className="booking-host">with {booking.guestName}</p>
                                            </div>
                                ...
                                <div className="empty-state">
                                    ...
                                    <p className="empty-state-title">No upcoming episodes</p>
                                    <p className="empty-state-description">
                                        Find and book amazing guests for your podcast
                                    </p>
                                    <Link to="/discover" className="btn btn-primary">
                                        Find Guests
                                    </Link>
                    ...
                    <div className="dashboard-section">
                        <div className="section-header-inline">
                            <h2 className="section-title-small">Booking Requests</h2>
                                ...
                                pendingBookings.map(booking => (
                                    <div key={booking.id} className="request-card">
                                        <div className="request-header">
                                            <h4 className="request-title">{booking.guestName}</h4>
